...
export class Vector2Class extends ObjectClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "public boolean equals(Vector2 otherVector)", native: Vector2Class.prototype._nEquals , comment: JRC.objectEqualsComment},
    ...
    _nEquals(other: Vector2Class): boolean {
