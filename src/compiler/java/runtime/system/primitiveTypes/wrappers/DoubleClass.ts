...
export class DoubleClass extends NumberClass {
    ...
    static __javaDeclarations: LibraryDeclarations = [
        {type: "c", signature: "class Double extends Number"},
        ...
        {type: "m", signature: "public final double doubleValue()", native: DoubleClass.prototype.doubleValue, template: "§1.value"},
        {type: "m", signature: "public final float floatValue()", native: DoubleClass.prototype.floatValue, template: "Math.fround(§1.value)"},
        {type: "m", signature: "public final int intValue()", native: DoubleClass.prototype.intValue, template: "(Math.trunc(§1.value) % 0x100000000 - 0x80000000)"},
        {type: "m", signature: "public final long longValue()", native: DoubleClass.prototype.longValue, template: "Math.trunc(§1.value)"},
        {type: "m", signature: "public int compareTo(Double otherValue)", native: DoubleClass.prototype._compareTo},
        {type: "m", signature: "public int parseDouble(String s)", native: DoubleClass.prototype.parseDouble},
        {type: "m", signature: "public static Double valueOf(double f)", native: DoubleClass.valueOf},
        {type: "m", signature: "public static Double valueOf(String s)", native: DoubleClass.valueOfString},
    ]
