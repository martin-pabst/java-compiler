...
export class StringClass extends ObjectClass implements IPrimitiveTypeWrapper {
    ...
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "public final int compareTo(String otherString)", template: "§1.value.localeCompare(§2.value)", java: StringClass.prototype._mj$compareTo$int$T , comment: JRC.comparableCompareToComment},
        { type: "method", signature: "public final int compareToIgnoreCase(String otherString)", native: StringClass.prototype._nCompareToIgnoreCase, template: "§1.value.localeCompare(§2, undefined, { sensitivity: 'accent' })" , comment: JRC.compareToIgnoreCaseComment},
