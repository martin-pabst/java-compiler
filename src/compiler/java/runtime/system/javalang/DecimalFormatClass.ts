...
class Pattern {
    positivePraefix: string|null = "";
    positiveSuffix: string|null = "";
    negativePraefix: string|null = "";
...
export class DecimalFormatClass extends ObjectClass {
    ...
    private static stringWithZeroes: string = "0000000000000000000000000000000000000000";
    private formatString: string ="00.00";
    constructor(){
        super();
    }
    _constructor1(format:string){
        ...
        if (exp > this.pattern.maximumIntegerDigits) {
            ...
            if (fractionPart != null) {
                ...
                if (neededFractionDigits > 0) {
                    fractionPart += DecimalFormatClass.stringWithZeroes.substring(0, neededFractionDigits);
                }
            ...
            if (neededIntegerDigits > 0) {
                integerPart = DecimalFormatClass.stringWithZeroes.substring(0, neededIntegerDigits) + integerPart;
            }
